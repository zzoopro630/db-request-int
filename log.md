...
- A업체 보장분석/일반 항목, 80,000원(취소선)에서 70,000원으로 '12월 특가' 표시
- A업체 보장분석/일반 항목, '3주 이내 납품 완료 DB'를 '신청월 내 공급' 으로 텍스트 수정
- B업체 '3주납품' 상품 외 모든 항목에서 '3주 이내 납품 완료 DB'를 '신청월 내 공급' 으로 텍스트 수정
